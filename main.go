...
// Для однообразности введён else if
...
// Удалён лишний "else", замена snake_case на camelCase.
...
// Замена snake_case на camelCase. Для однообразности введён else if
...
// Замена snake_case на camelCase
